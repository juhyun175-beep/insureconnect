...
- 카테고리: underwrite(인수심사: 고혈압·당뇨·갑상선암 등 질병으로 가입 가능/부담보/할증/거절), disclosure(고지·알릴의무), claim(보상: 실손·암·수술비·후유장해 등 지급/거절)
- 잡담·인사·광고·질문만 있고 결과 없는 것은 제외. 개인정보는 이미 마스킹됨([이름] 등).
...
- 사례가 없으면 {"cases":[]} 만 출력. summary는 한국어 한두 줄.`;
