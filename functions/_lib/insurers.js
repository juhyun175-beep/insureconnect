...
// Exact aliases only. Ambiguous aliases are intentionally excluded.
export const INSURER_ALIASES = {
  '신한생명': 'shinhan-life', '한화생명': 'hanwha-life', '삼성생명': 'samsung-life',
  '교보생명': 'kyobo-life', '현대해상': 'hyundai-marine', '삼성화재': 'samsung-fire',
  'KB손해보험': 'kb-insurance', 'DB손해보험': 'db-insurance', '메리츠화재': 'meritz-fire',
};
...
export function insurerSlugForName(name) {
  ...
  if (Object.prototype.hasOwnProperty.call(INSURER_ALIASES, value)) matches.add(INSURER_ALIASES[value]);
