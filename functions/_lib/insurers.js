...
export const INSURER_ALIASES = {
  ...
  'fubon-hyundai-life':['푸본현대생명','푸본현대','현대'], 'im-life':['IM라이프','IM생명','DGB생명'],
  'kdb-life':['KDB생명','KDB'], 'kb-life':['KB라이프','KB생명'], 'db-life':['DB생명','DB'],
  ...
  'meritz-fire':['메리츠화재','메리츠'], 'hanwha-general':['한화손해보험','한화손보','한화'],
