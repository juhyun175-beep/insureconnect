...
// .wrangler/tmp/pages-94gew0/functionsWorker-0.2511386328872216.mjs
...
async function onRequestPost(context) {
  ...
  const emailRes = await fetch("https://api.web3forms.com/submit", {
    ...
    body: JSON.stringify({
      ...
      message: `\u{1F4EC} \uBCF4\uD5D8\uC9C0\uC2DD \uD3EC\uC2A4\uD2B8\uC5D0 \uC0C8 \uB313\uAE00\uC774 \uB2EC\uB838\uC2B5\uB2C8\uB2E4.
...
var SB_ANON = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ6bGxweW1odHlnbm9vZHVldmdmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzIzMjg1NjYsImV4cCI6MjA4NzkwNDU2Nn0.Z2K720NiFo191fVBllr0_OiTxvJYjwTSv3ZSiNgc2bs";
var TRUSTED_IMAGE_PREFIX = `${SB_URL}/storage/`;
var DEFAULT_OG_IMAGE = "https://insureconnect-hub.pages.dev/logo-full.png";
var SB_HEADERS = { apikey: SB_ANON, Authorization: `Bearer ${SB_ANON}` };
...
async function onRequest(context) {
  ...
  const isRoot = (reqUrl.pathname === "/" || reqUrl.pathname === "/index.html") && request.method === "GET";
  ...
  try {
    if (newsId) {
      ...
      if (rows) {
        ...
        og = buildOg({
          title: `${rows[0].title} \xB7 InsureConnect \uCE74\uB4DC\uB274\uC2A4`,
      ...
      if (rows) {
        const p = rows[0];
        const plain = (p.content || "").replace(/\[img:[^\]]+\]/g, "").replace(/\s+/g, " ").trim().slice(0, 150);
        og = buildOg({
          title: `${p.title} \xB7 InsureConnect \uBCF4\uD5D8\uC9C0\uC2DD`,
...
// .wrangler/tmp/bundle-tc2lDz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tc2lDz/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2511386328872216.js.map
